...
## Knowledge Base
All masterclass notes should be saved in:
...
> **Note:** If these files don't exist yet in `~/.hermes/workspace/investing/`, check
> the original OpenClaw workspace at `~/.openclaw/workspace/investing/` — they may
> need to be migrated or recreated.
...
## References
- `references/csp-screening-2026-05-21.md` — 2-stage CSP screening protocol, May 21, 2026 screening results, top CSP candidates
