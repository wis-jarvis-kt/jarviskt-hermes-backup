...
> **Note:** `skills/_brain-filing-rules.md` referenced in this skill was part of the
> original OpenClaw brain system. The brain MCP server (`gbrain`) is not currently
> connected — these filing rules are aspirational until the MCP is reconfigured.
...
broken brain.
*(Note: The `skills/_brain-filing-rules.md` format rule referenced here was part of
the original OpenClaw brain system — aspirational until gbrain MCP is reconfigured.)*
...
1. Check notability gate *(aspirational — gbrain MCP not currently connected)*
2. Check filing rules *(aspirational — gbrain MCP not currently connected)*
