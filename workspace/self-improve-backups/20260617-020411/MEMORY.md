...
- gbrain MCP server (3 skills: gbrain-brain-ops, gbrain-enrich, gbrain-signal-detector) — **archived** since OpenClaw migration. Skills reside in `~/.hermes/skills/.archive/openclaw-imports/gbrain-*`. If reconnection is needed, check that archive location first.
...
## Recent Key Events
- **2026-06-16:** Memory consolidation — purged 8 memory logs (Jun 8-9). Retained Jun 10-15 daily logs.
